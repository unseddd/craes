...
/// [42; 16] => [42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 42, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16, 16]
...
mod tests {
    ...
    #[test]
    fn check_invalid_unpad() {
        let no_pad_bytes = b"This has no pad!";
        assert!(unpad(no_pad_bytes.as_ref()).is_err());
    }
}
